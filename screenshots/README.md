...
![placing post example](screenshots/3-placingtextpost.png)
> After confirming to post, you have a ghost view of your post, and can click anywhere to post it.

### Drawing Post
![drawing](screenshots/4-drawingpostwcaption.png)
...
### Posting a drawing
![postingdrawing](screenshots/5-postingdrawingghost.png)
...
### Attachment Post
![attachmentpost](screenshots/6-postingattachmenttest.png)
...
![postingattachment](/Users/chaicallow/Documents/GitHub/bulletin-board/screenshots/7-postingattachmentplace.png)
...
### Search bar
![searchbar](screenshots/8-searchbarfunction.png)
...
![scoreview](screenshots/9-viewingpostexample.png)
...
## Trials
![trialstarttoast](screenshots/13-TrialStartpopup.png)
...
### Accused's Defense
![defensescreen](screenshots/10-accuseddefensescreen.png)
...
![votescreen](screenshots/14-votingtrialscreen.png)
...
![wickedfloodwarning](screenshots/17-floodwarning-wickedness.png)
...
![moderationwarning](screenshots/21-floodwarning-moderation-text.png)
...
![textfilter](screenshots/22-flood-moderation-text-category.png)
...
![imagefilter](screenshots/23-flood-moderation-image.jpg)
...
### Flood start
![floodanimation](screenshots/18-floodanimation.png)
...
### Submerged
![submerge](screenshots/19-submergedscreen.png)
...
![reset](screenshots/20-resetscreen.png)
